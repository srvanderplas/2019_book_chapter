...
```{r Hamby-CMS, fig.cap = "Proportion of pairs of bullets with same (light blue) or different (dark blue) source given observed number of CMS}.", out.width = ".75\\textwidth", fig.width = 6, fig.height = 4}
