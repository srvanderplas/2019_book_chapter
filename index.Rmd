...
p + 
  geom_line(data = tmpnest$model[[2]], 
            aes(x = x, y = y), size=1.5, colour="darkorange", fill=NA) +
  geom_line(data = tmpnest$model[[1]], 
            aes(x = x, y = y), size=1.5, colour="darkgrey", fill=NA) +
